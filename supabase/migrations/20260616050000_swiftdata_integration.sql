-- SwiftData Ghana provider fields
ALTER TABLE public.data_packages
  ADD COLUMN IF NOT EXISTS swift_package_id TEXT;
...
-- New orders start as processing until SwiftData confirms delivery
...
BEGIN
  ...
  INSERT INTO public.data_orders (
    ...
    v_user_id, v_pkg.id, v_pkg.network, v_pkg.size_gb, v_price, trim(p_recipient_phone), 'processing'
